    ...
    <main>
      ...
      <div class="container g-bg-white g-brd-around g-brd-white g-brd-2 g-mt-80 g-pa-30" style="min-height:100vh;">
        <div class="u-heading-v3-1 text-center g-mb-15">
          ...
          ?>
            <div class="row">
              <div class="col-8"><h2 style="text-align:center;background-color:<?php echo $class[1]; ?>;"><?php echo $class[0]; ?></h2></div>
              <div class="col-4"><img style="position:absolute;" src="<?php echo $class[2]; ?>" /></div>
            </div>
          <?php
            }
          ?>
