  ...
  <body>
    <main style="background:rgba(255,255,255,0.01);">
      ...
      <article class="g-mb-15 g-pa-10 g-brd-around g-brd-gray-light-v4">
        <div class="g-ma-10">
          <a target="_blank" href="<?php the_post_thumbnail_url(); ?>"><img class="img-fluid w-100 g-mb-25" src="<?php the_post_thumbnail_url(get_the_ID(), 'Medium-Large'); ?>" alt="Image Description"></a>
