...
?>
<ul id="app-accordion" class="nav flex-column u-nav-v3-1" role="tablist" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-lightgray" aria-multiselectable="false">
    ...
    <!-- Open -->
    <li class="nav-item">
        <a class="nav-link <?php echo $actOpen[1] ?> g-color-blue" href="#open-body" data-toggle="collapse" data-parent="#app-accordion" aria-expanded="true" aria-controls="open-body">
    ...
    <div id="open-body" class="<?php echo $actOpen[2] ?> g-ml-20" role="tabpanel">
      <?php
    ...
    <!-- Accepted -->
    <li class="nav-item">
        <a class="nav-link <?php echo $actAccept[1] ?> g-color-primary" href="#accepted-body" data-toggle="collapse" data-parent="#app-accordion" aria-expanded="false" aria-controls="accepted-body">
            <span class="d-inline-block">
              <i class="fa fa-circle-o-notch u-tab-line-icon-pro g-mr-3"></i>
    ...
    <div id="accepted-body" class="<?php echo $actAccept[2] ?> g-ml-20" role="tabpanel">
      <?php
    ...
    <!-- Accepted -->
    <li class="nav-item">
        <a class="nav-link <?php echo $actDecline[1] ?> g-color-red" href="#declined-body" data-toggle="collapse" data-parent="#app-accordion" aria-expanded="false" aria-controls="declined-body">
            <span class="d-inline-block">
              <i class="fa fa-circle-o-notch u-tab-line-icon-pro g-mr-3"></i>
    ...
    <div id="declined-body" class="<?php echo $actDecline[2] ?> g-ml-20" role="tabpanel">
      <?php
