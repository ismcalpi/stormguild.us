...
<article class="text-center g-color-white g-overflow-hidden g-rounded-4" >
...
<?php
		...
		foreach($specs as $spec) {
			...
			if($spec['is_active'] == TRUE) {
				...
				$iconStatus = '<img src="'.$imgPath.'" style="height:25px;padding-right:2px;opacity:.33" title="'.$spec['spec_name'].' '.$class['class_name'].'" />';
			}
			echo $iconStatus;
		}
?>
