		...
		<main>
			...
			<div class="container main-container g-mt-80">
				...
				<div class="row">
			      ...
			      <img class="g-brd-7 g-brd-style-solid g-brd-white g-width-100 g-height-100 rounded-circle g-pull-50x-up" src="<?php echo $json_user[0]->logo; ?>" alt="Image Description">
			      <div class="g-mt-minus-20">
			        <h4 class="h6 g-color-primary g-font-weight-600 text-uppercase g-mb-5"><?php echo $json_user[0]->display_name; ?></h4>
