  ...
  <body class="main-body">
    <main>
      ...
      <div class="container g-bg-white g-brd-around g-brd-white g-brd-2 g-mt-80 g-pa-30" style="min-height:100vh;">
        <div class="row" style="background-image: url('<?php echo $_SERVER['DOCUMENT_ROOT'].'/assets/img/guildroster/banner.jpg' ?>');background-size: cover;background-repeat: no-repeat;);">
          <h1>Guild Roster</h1>
        </div>
        <div class="row">
            <?php
