...
<?php
	...
	foreach($classes as $class) {
		...
		echo '<div style="color:'.$class['class_color'].';text-transform: uppercase;" class="col-lg-3 col-sm-3 text-right g-pa-10 g-my-5">'.$class['class_name'].'</div>';

		echo '<div class="col-lg-3 col-sm-3 g-my-5 text-left">';
