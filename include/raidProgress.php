<?php
	...
	?>
		<div class="col-lg-12 col-sm-12 g-pa-0 g-ma-0">
			<div class="u-bg-overlay g-bg-black-gradient-opacity-v1--after g-pa-0 g-ma-0" role="tab">
				<img style="max-height:60px;width:100%;" class="img-fluid" src="img/ranking.jpg">
			</div>
	...
	$raids = $db -> select("SELECT raid_name, 
	...
	foreach($raids as $raid) {
		...
		$bosses = $db -> select("SELECT boss_name, lower(replace(boss_name,' ','')) as boss_path, status, date_format(kill_date, '%b %D, %Y') as kill_date
