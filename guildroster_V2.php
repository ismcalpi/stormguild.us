                ...
                foreach ($results as $result) {
                    ...
                    <div class='col-lg-4 col-md-6 col-12 g-mb-30'>
                        <figure class="u-block-hover u-shadow-v2 g-bg-white g-pa-5">
                            <div style="background-color:rgba(0,0,0,.75);border-radius: 50px 5px 5px 50px; border: 2px solid #000000" class="d-flex justify-content-start">
                                <img class="g-width-80 g-height-80" src="http://render-us.worldofwarcraft.com/character/<?php echo $result['thumbnail']; ?>">
