                ...
                foreach ($results as $result) {
                    ...
                    <div class='col-lg-4 col-md-6 col-12 g-mb-30'>
                        <figure class="u-block-hover u-shadow-v2 g-bg-white g-pa-0">
                            <div style="background-color:rgba(0,0,0,.75);border-radius: 25px; border: 2px solid #FFFFFF" class="d-flex justify-content-start g-pa-0">
                                ...
                                <figcaption style="background-color:rgba(0,0,0,.5); border-radius: 25px;" class="u-block-hover__additional--fade g-pa-30">
