            ...
            foreach ($classList as $class) {
                ...
                foreach ($results as $result) {
                    ...
                    <div class='col-lg-4 col-md-6 col-12 g-mb-30'>
                        <figure style="border-radius: 50px 10px 10px 50px; border: 2px solid #000000" class="u-block-hover u-shadow-v2 g-bg-white g-pa-5">
                            <div style="background-color:rgba(0,0,0,.75)" class="d-flex justify-content-start">
                                <img class="g-width-100 g-height-100" src="http://render-us.worldofwarcraft.com/character/<?php echo $result['thumbnail']; ?>">
