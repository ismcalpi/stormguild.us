                ...
                foreach ($results as $result) {
                    ...
                    <div class='col-lg-4 col-md-6 col-12 g-mb-30'>
                        <figure class="u-block-hover u-shadow-v2 g-bg-white g-pa-0">
                            <div style="background-color:rgba(255,255,255,0);border-radius: 25px; border: 2px solid #000000" class="d-flex justify-content-start g-pa-0">
                                ...
                                <div class="d-block g-mx-10">
                                    <h4 style="color:<?php echo $class[1]; ?>; text-shadow: 0px 0px 5px #000, -1px -1px #000, 1px 1px #000;" class="h5 g-mt-15 g-mb-5"><?php echo $result['name']; ?></h4>
                                    <em class="d-block g-color-black g-font-style-normal g-font-size-small g-mb-15 g-mt-0"><?php echo $rank_name ?></em>
                                </div>

                                <figcaption style="background-color:rgba(0,0,0,.6); border-radius: 25px;" class="u-block-hover__additional--fade g-pa-30">
